# ble_gesture_drive.py  ----  손 제스처 앱(MediaPipe) 명령 수신 -> 포니봇 주행
#   웹앱이 보내는 명령: forward / backward / left / right / stop
#     손가락 1=전진 2=후진 3=좌회전 4=우회전 0/없음=정지
#   ※ 이 웹앱은 'ESP-KJI'를 찾으므로 기기 이름을 반드시 'ESP-KJI'로 둡니다.
